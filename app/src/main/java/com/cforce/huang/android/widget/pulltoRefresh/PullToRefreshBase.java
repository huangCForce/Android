...
import com.cforce.huang.android.widget.internal.FlipLoadingLayout;
import com.cforce.huang.android.widget.internal.ILoadingLayout;
import com.cforce.huang.android.widget.internal.LoadingLayout;
import com.cforce.huang.android.widget.internal.RotateLoadingLayout;
import com.cforce.huang.android.widget.internal.Utils;
import com.cforce.huang.android.widget.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	public static final int SMOOTH_SCROLL_LONG_DURATION_MS = 425;
	static final int DEMO_SCROLL_INTERVAL = 325;
	...
	private void pullEvent() {
		...
		switch (mCurrentMode) {
			case PULL_FROM_END:
				...
				newScrollValue = Math.round((initialMotionValue - lastMotionValue) / FRICTION);
