...
import com.cforce.huang.android.widget.internal.IndicatorLayout;
import com.cforce.huang.android.widget.internal.NoticeListScrollStateChangedListener;
...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
	...
	private NoticeListScrollStateChangedListener changedListener;

	private boolean mShowIndicator;
	private boolean mScrollEmptyView = true;

	public void setChangedListener(
			NoticeListScrollStateChangedListener changedListener) {
	...
	public final void onScrollStateChanged(final AbsListView view, final int state) {
		...
		if (changedListener != null) {
			changedListener.changedListener(state);
		}
	}
