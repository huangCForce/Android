 ...
 *******************************************************************************/
package com.cforce.huang.android.widget.internal;
...
import com.cforce.huang.android.widget.pulltoRefresh.PullToRefreshBase;
...
public abstract class LoadingLayout extends FrameLayout implements ILoadingLayout {
	...
	public final void refreshing() {
		...
		if (mUseIntrinsicAnimation) {
			((AnimationDrawable) mHeaderImage.getBackground()).start();
		} else {
			// Now call the callback
			refreshingImpl();
		}
	...
	public final void reset() {
		...
		if (mUseIntrinsicAnimation) {
			((AnimationDrawable) mHeaderImage.getBackground()).stop();
		} else {
			// Now call the callback
			resetImpl();
		}
